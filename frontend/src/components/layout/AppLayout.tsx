...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Fixed top bar for main content: theme toggle only. Hidden on /chat so it doesn't sit on top of the Messages sidebar */}
      {pathname !== '/chat' && (
      ...
      <div className={`lg:ml-64 pt-16 ${pathname === '/chat' ? 'lg:pt-0' : 'lg:pt-12'}`}>
        {children}
      </div>
    </div>
  );
